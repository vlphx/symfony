 ...
 */
final class Version20220405154455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_292FFF1D6BF4B111 ON vehicule (moteur_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_292FFF1D6BF4B111 ON vehicule');
